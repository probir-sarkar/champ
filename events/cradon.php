...
<head>
    ...
    <title>FORESET COUNTY POTAWATOMI BRUSH RUN | AMSOIL Championship Off-Road</title>
...
<body>
    ...
    <div class="container-fluid p-0 event-notice mt-5">
        <img src="<?php echo $path; ?>images\events\EVENT_HEADER_02_CRANDON.jpg" class="img-fluid">
    </div>
    <!-- Countdown -->
