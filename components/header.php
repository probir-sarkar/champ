                ...
                <div class="row nav-dropdown-font" style="width: 100%;">
                    <div class="col-lg-4 d-flex">
                        ...
                        <ul class="navbar-nav px-3">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link " href="<?php echo $path ?>http://example.com" id="navbarDropdownMenuLink"
                    ...
                    <div class="col-lg-4 d-flex"><a href="<?php echo $path ?>index.php"><img
                                class="navbar-brand d-none d-lg-block brand-logo-img" src="<?php echo $path ?>SITE_LOGO2.png"></a>
                    </div>
                    <div class="col-lg-4 d-flex">
                        <ul class="navbar-nav px-3">
                            <li class="nav-item ">
